...
const Testimonials = () => {
  return (
    <div className="flex justify-center gap-[100px] md:flex-row flex-col items-center">
      <div>
      ...
      <div className="flex flex-col gap-[20px] px-[5px] my-10 md:flex-row justify-center items-start">
        <div className="w-[362px] md:w-[400px] md:h-[189px] shadow-md rounded-[8px] px-[20px] py-[8px]">
          <p className="border-l-[3px] text-[12px] md:text-[14.9px] border-l-[#4640DE] pl-[20px]">
          ...
          <div className="flex justify-start gap-7 mt-[32px] items-center">
            <div>
              <Avatar
                sx={{
                  bgcolor: "white",
        ...
        <div className="w-[362px] md:w-[400px] md:h-[189px] shadow-md rounded-[8px] px-[20px] py-[8px]">
          <p className="border-l-[3px] text-[12px] md:text-[13.5px] border-l-[#4640DE] pl-[20px]">
          ...
          <div className="flex justify-start gap-7 mt-[16px] items-center">
            ...
            <div>
              <h2 className="font-bold text-[14px]">Jasmeet Singh Bhatia</h2>
              <p className="text-[#666666] text-[12px]">
