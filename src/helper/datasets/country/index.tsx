export const countryList = [
    ...
    {value: 'Congo (Congo-Brazzaville)', name: 'Congo (Congo-Brazzaville)'},
    {value: 'Costa Rica', name: 'Costa Rica'},
    {value: 'Croatia', name: 'Croatia'},
    {value: 'Cuba', name: 'Cuba'},
    {value: 'Cyprus', name: 'Cyprus'},
    {value: 'Czechia (Czech Republic)', name: 'Czechia (Czech Republic)'},
    ...
    {value: 'Eswatini (fmr. "Swaziland")', name: 'Eswatini (fmr. "Swaziland")'},
    ...
    {value: 'Korea, North', name: 'Korea, North'},
    ...
    {value: 'North Macedonia (formerly Macedonia)', name: 'North Macedonia (formerly Macedonia)'},
